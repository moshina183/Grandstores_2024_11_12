...
@Entity
@Table(name = "XXGS_WMS_USER_ORG_GROUPS")
public class UserOrgGroupEO {
 
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "userOrg_id_seq")
    @SequenceGenerator(name = "userOrg_id_seq",sequenceName = "XXGS_USER_ORG_GROUP_ID_S", allocationSize = 1)

    @Column(name = "USER_ORG_GROUP_ID")
    public BigDecimal userorgroupId;
    ...
    public UserOrgGroupEO() {
    }

    public BigDecimal getUserorgroupId() {
        return userorgroupId;
    }

    public void setUserorgroupId(BigDecimal userorgroupId) {
    ...
    public UserOrgGroupEO(BigDecimal userorgroupId, BigDecimal userId, BigDecimal organizationId, String enabledFlag,
            ...
            String attribute15, Date lastUpdateDate, BigDecimal lastUpdatedBy, Date createdDate, BigDecimal createdBy,
