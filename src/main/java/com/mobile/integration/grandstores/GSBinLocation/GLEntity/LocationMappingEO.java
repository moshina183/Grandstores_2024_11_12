...
@Entity
@Table(name = "XXGS_ITEM_LOC_MAPPING")
public class LocationMappingEO {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "loc_id_seq")
    @SequenceGenerator(name = "loc_id_seq",sequenceName = "XXGS_ITEM_LOC_MAPPING_ID_S", allocationSize = 1)
    @Column(name = "ITEM_LOC_MAPPING_ID")
    public BigDecimal item_loc_mapping_id;
    ...
    @Column(name = "ITEM_SEGMENT1")
    public String item_segment1;
    
    @Column(name = "ITEM_SEGMENT2")
    public String item_segment2;
    
    @Column(name = "ITEM_SEGMENT3")
    public String item_segment3;
    
    @Column(name = "DESCRIPTION")
    public String description;
    
    @Column(name = "SUB_INVENTORY_CODE")
    public String sub_inventory_code;
    
    @Column(name = "LOCATOR_ID")
    public BigDecimal locator_id;
    ...
    @Column(name = "BIN_CAPACITY")
    public String bin_capacity;


    public BigDecimal getItem_loc_mapping_id() {
        return item_loc_mapping_id;
    }

    public void setItem_loc_mapping_id(BigDecimal item_loc_mapping_id) {
        this.item_loc_mapping_id = item_loc_mapping_id;
    }
    ...
    public String getItem_segment1() {
        return item_segment1;
    }

    public void setItem_segment1(String item_segment1) {
        this.item_segment1 = item_segment1;
    }

    public String getItem_segment2() {
        return item_segment2;
    }

    public void setItem_segment2(String item_segment2) {
        this.item_segment2 = item_segment2;
    }

    public String getItem_segment3() {
        return item_segment3;
    }

    public void setItem_segment3(String item_segment3) {
        this.item_segment3 = item_segment3;
    }
    ...
    public String getSub_inventory_code() {
        return sub_inventory_code;
    }

    public void setSub_inventory_code(String sub_inventory_code) {
    ...
    public LocationMappingEO() {
    }

    public String getBin_capacity() {
        return bin_capacity;
    }

    public void setBin_capacity(String bin_capacity) {
        this.bin_capacity = bin_capacity;
    }

    public LocationMappingEO(BigDecimal item_loc_mapping_id, BigDecimal org_id, BigDecimal organization_id,
            String organization_code, String organization_name, BigDecimal inventory_item_id, String item_code,
            String item_segment1, String item_segment2, String item_segment3, String description,
            String sub_inventory_code, BigDecimal locator_id, String locator_name, String attribute_category,
            ...
            BigDecimal last_upDate_login, String bin_capacity) {
        this.item_loc_mapping_id = item_loc_mapping_id;
        this.org_id = org_id;
        this.organization_id = organization_id;
        this.organization_code = organization_code;
