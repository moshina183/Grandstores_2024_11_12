...
@Entity
@Table(name = "XXGS_PI_LOT_DETAILS")

public class PiLotDetailsEO {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pilot_id_seq")
    @SequenceGenerator(name = "pilot_id_seq",sequenceName = "XXGS_PI_LOT_ID_S", allocationSize = 1)
    @Column(name = "LOT_ID")
    ...
    public PiLotDetailsEO(BigDecimal lotId, BigDecimal lineId, BigDecimal headerId, BigDecimal itemId, String itemCode,
            String itemDescription, String lotNumber, Date lotExpiryDate, BigDecimal lotQuantity,
